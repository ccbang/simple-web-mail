export default {
  ...
  'menu.email': 'Emails',
  'menu.email.create': 'New Mail',
  'menu.email.mailbox': 'INBOX',
  'menu.email.send': 'Sent',
  'menu.email.delete': 'Deleted',
  'menu.email.befor': 'Drfat',
  'menu.email.detail': 'Mail Detail',
  'menu.frends': 'Contcat',
  ...
  'app.login.tab-login-wechat': 'Wechat Login',
